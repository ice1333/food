	...
	function del2(){
		if(confirm("정말 삭제하시겠습니까?")){
		 $.ajax({
			url: 'delete.do',
			type: 'get',
			data:{rqna_no:${vo.rqna_no}},
			success:function(){
				alert('정상적으로 삭제되었습니다.');
				location.href="restaurantList.do";
			}
		});
	 ...
	 function goSave(){
		$.ajax({
			...
			success:function(){
					...
					$("#content").val("");
					commentList('rqna',${vo.rqna_no});
			
			}
		})
	}
	function commentList(tablename, rqna_no){
	$.ajax({
		url:'/res/comment/adqlist.do',
		data:{tablename:tablename, rqna_no:rqna_no},
	                ...
	                <div class="bbs">
	                    ...
	                    <div class="view">
	                        <div class="title">
	                            <dl>
	                                <dt>${vo.rqna_title}</dt>
	                                <dd class="date">${vo.rqna_regdate}</dd>
	                            </dl>
	                        </div>
	                        <div class="cont"><p>${vo.rqna_contents}</p> </div>
	                        <dl class="file">
	                            <dt>첨부파일 </dt>
	                            <dd>
	                        ...
	                        <div class="btnSet clear">
	                            <div class="fl_l">
	                          <a href="restaurantList.do" class="btn">목록</a>
	                		...
	                		<div>
			                    ...
			                    <input type="hidden" name="tablename" value="rqna">
			                    <!--<input type="hidden" name="a_no" value="${vo.a_no}"> 여기현수형이 -->
			                    <input type="hidden" name="rqna_no" value="${vo.rqna_no}">
