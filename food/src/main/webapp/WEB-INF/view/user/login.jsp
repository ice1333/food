...
<%@ include file="/WEB-INF/view/include/user_header.jsp" %>
	<form action="login.do" method="post" id="user" name="user" onsubmit="return loginCheck();">
		<div class="sub">
		    <div class="size">
		        ...
		        <div class="member">
		            <div class="box">
		                <fieldset class="login_form">
		                    <ul>
		                        <li><input type="text" id="email" name="u_uemail" placeholder="이메일"></li>
		                        <li><input type="password" id="pwd" name="u_pwd" placeholder="비밀번호"></li>
